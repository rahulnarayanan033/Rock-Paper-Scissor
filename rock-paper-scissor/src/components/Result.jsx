...
export default function Result(props) {
  ...
  return (
    <div>
      ...
      {props.option === "rock" ? (
        <span id="rock2" className="rock-paper-scissor big">
          <svg
            id="rockImg"
            className="rcp"
        ...
        <span id="paper2" className="rock-paper-scissor big">
          <svg
            id="paperImg"
            className="rcp"
            xmlns="http://www.w3.org/2000/svg"
          ...
          {/* {isVisible ? <HousePicked option={props.housePicked} /> : <Loader />} */}
        </span>
      ) : (
        <span id="scissor2" className="rock-paper-scissor big">
          <svg
            id="scissorImg"
            className="rcp"
            xmlns="http://www.w3.org/2000/svg"
